 ...
 *     });
    ...
    function $CompileProvider($provide) {
        ...
        this.$get = [
            ...
            '$controller',
            function ($injector, $interpolate, $exceptionHandler, $http, $templateCache, $parse, $controller) {
                ...
                function compileNodes(nodeList, transcludeFn, rootElement, maxPriority) {
                    ...
                    /* nodesetLinkingFn */
                    function linkingFn(scope, nodeList, rootElement, boundTranscludeFn) {
                ...
                function applyDirectivesToNode(directives, templateNode, templateAttrs, transcludeFn, rootElement) {
                    ...
                    /* directiveLinkingFn */
                    function compositeLinkFn(/* nodesetLinkingFn */ childLinkingFn, scope, linkNode, rootElement, boundTranscludeFn) {
                ...
                function compileTemplateUrl(directives, /* directiveLinkingFn */ beforeWidgetLinkFn, tElement, tAttrs, rootElement, replace, transcludeFn) {
                    var linkQueue = [],
                        afterWidgetLinkFn,
                    ...
                    return /* directiveLinkingFn */ function (ignoreChildLinkingFn, scope, node, rootElement, controller) {
                        if (linkQueue) {
